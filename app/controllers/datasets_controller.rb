...
def upload_members
    ...
    def downloads
    	@v_months = Month.with_violence_report.sort_by { |month| month.name }.reverse
    	@s_months = Month.with_social_report.sort_by { |month| month.name }.reverse
    	@f_months = Month.with_forecast_report.sort_by { |month| month.name }.reverse
