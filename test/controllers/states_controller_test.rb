...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { code: @state.code, name: @state.name, population: @state.population, shortname: @state.shortname } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { code: @state.code, name: @state.name, population: @state.population, shortname: @state.shortname } }
